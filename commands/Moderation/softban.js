...
module.exports = {
   name: 'softban',
   aliases: ['sb'],
   description: 'Kicks a member but purges 24 hours worth of messages',
   ...
   async execute(message, args, client) {
        ...
        if (mentionedMember.id === message.author.id) return message.channel.send("Trying to softban yourself? How unfortunate. Can\'t let you do that. :(")
        ...
        if (mentionedMember.bannable){
            ...
            **Time:** ${moment().format('llll')}
            ...
            return message.channel.send("I can\'t Softban this user. Make sure I have permissions!!")
        }
        return undefined
